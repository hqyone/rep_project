...
class ENCODE_DataExplorer:
    ...
    def getBamFiles(self, manifest_file, URL, genome='hg19', output_type="unfiltered alignments", anno='NA'):
        ...
        CONTROL_EXP_BAM_DIC = {}
        files_dic = {}
        title = "files\tbam_files\tENCODE\texp_id\tassay\tfiles_size\trun_type\ttarget\tbiosample\torgam\tdescription\tderived_files\tgenome\tgenome_anno\n"
        FILE.write(title)
                                ...
                                if assembly == genome:
                                    ...
                                    if 'derived_from' in file_obj:
                                        for bam_id in file_obj['derived_from']:
                                            ...
                                            file_num+=1
                        files_dic[f] =f
                        if (max_file_num>0 && file_num>=max_file_num){
                            break;
                        }
        FILE.close()
        print ("The data sources extraction is done!")
...
a.getBWFiles("", HepG2_shRNA_RNA_URL, genome='GRCh38', output_type="unfiltered alignments", anno='V24', pepline="tophat")
```
...
wk_dir  = "/media/hqyone/SeagateDrive2/HepG2/shRNA/bw"
target_file = "/home/hqyone/workspace/code/rep_project_code/HepG2_shRNA_RNA_ali_h38_tophat_bw_list.txt"
